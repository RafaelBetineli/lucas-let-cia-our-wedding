...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lucas & Letícia · 20.11.2026" },
      { name: "description", content: "Site oficial do casamento de Lucas e Letícia — 20 de novembro de 2026. Confirme sua presença, veja nossa história e detalhes da cerimônia." },
      { name: "author", content: "Lucas & Letícia" },
      { property: "og:title", content: "Lucas & Letícia · 20.11.2026" },
      { property: "og:description", content: "Site oficial do casamento de Lucas e Letícia — 20 de novembro de 2026. Confirme sua presença, veja nossa história e detalhes da cerimônia." },
